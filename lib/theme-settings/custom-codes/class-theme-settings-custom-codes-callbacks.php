...
EOC; ?>
                <pre><code class="pre block whitespace-pre"><?php echo htmlspecialchars(
                    $sampleJs
                ); ?></code></pre>
            </div>
        </div>
    ...
    {
        $option = $lang
            ? get_option(self::OPTION_NAME_PREFIX . "_head_" . $lang)
            : get_option(self::OPTION_NAME_PREFIX . "_head");
        $name = $lang
            ? self::OPTION_NAME_PREFIX . "_head_" . esc_attr($lang)
        ...
        <div class="col-span-full">
            ...
            <div class="mt-2">
                <textarea id="custom_codes_head" name="' .
            $name .
            '" rows="5" placeholder="Your custom code" class="block w-full max-w-4xl rounded-md border-0 p-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#38bdf8]">' .
            esc_textarea($option) .
            '</textarea>
            </div>
    ...
    {
        $option = $lang
            ? get_option(self::OPTION_NAME_PREFIX . "_body_" . $lang)
            : get_option(self::OPTION_NAME_PREFIX . "_body");
        $name = $lang
            ? self::OPTION_NAME_PREFIX . "_body_" . esc_attr($lang)
        ...
        <div class="col-span-full">
            ...
            <div class="mt-2">
                <textarea id="custom_codes_body" name="' .
            $name .
            '" rows="5" placeholder="Your custom code" class="block w-full max-w-4xl rounded-md border-0 p-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#38bdf8]">' .
            esc_textarea($option) .
            '</textarea>
    ...
    {
        $option = $lang
            ? get_option(self::OPTION_NAME_PREFIX . "_footer_" . $lang)
            : get_option(self::OPTION_NAME_PREFIX . "_footer");
        $name = $lang
            ? self::OPTION_NAME_PREFIX . "_footer_" . esc_attr($lang)
        ...
        <div class="col-span-full">
            ...
            <div class="mt-2">
                <textarea id="custom_codes_footer" name="' .
            $name .
            '" rows="5" placeholder="Your custom code" class="block w-full max-w-4xl rounded-md border-0 p-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#38bdf8]">' .
            esc_textarea($option) .
            '</textarea>
